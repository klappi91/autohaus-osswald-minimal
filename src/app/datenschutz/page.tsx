...
export default function DatenschutzPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-24">
      ...
      <div className="space-y-16 text-sm leading-relaxed text-black/70">
            ...
            <div className="mt-4 space-y-6">
              ...
              <div>
                ...
                <p className="mt-2">
                  ...
                  sogenannten Analyseprogrammen. Die Analyse Ihres
        ...
        <section className="space-y-8">
          ...
          <div>
            <h3 className="text-lg font-medium text-black">Datenschutz</h3>
            <p className="mt-4">
          ...
          <div>
            ...
            <div className="mt-4 space-y-1">
              ...
              <p>Auf dem Esch 21</p>
              <p>D-49356 Diepholz</p>
            </div>
            <div className="mt-4 space-y-1">
              <p>Telefon: +49-(05441) 975551</p>
              <p>E-Mail: autohaus-osswald(at)web.de</p>
            </div>
            <p className="mt-4">
          ...
          <div>
            ...
            <p className="mt-4">
              ...
              <a
                ...
                className="text-black underline underline-offset-4 hover:text-[#f28627]"
              >
        ...
        <section className="space-y-8">
          ...
          <div>
            ...
            <div className="mt-6">
              <h4 className="font-medium text-black">IP-Anonymisierung</h4>
              <p className="mt-2">
            ...
            <div className="mt-6">
              <h4 className="font-medium text-black">Browser Plugin</h4>
              <p className="mt-2">
